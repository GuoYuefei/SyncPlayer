/**
 * 1. fork AlloyTeam ESLint 规则配置: https://github.com/AlloyTeam/eslint-config-alloy
 * 2. 包含所有 ESLint 标准规则
 * 3. 包含所有 React 规则
 * 4. 使用 babel-eslint 作为解析器
 *
 * @fixable 表示此配置支持 --fix
...
module.exports = {
    ...
    rules: {
        ...
        // @off 不建议函数的循环复杂度超过 20，https://en.wikipedia.org/wiki/Cyclomatic_complexity
        'complexity': 'off',
        // 禁止函数在不同分支返回不同类型的值
        // @off 太严格了
